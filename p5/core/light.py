...
def ambient_light(r: float, g: float, b: float):
...
def directional_light(r: float, g: float, b: float, x: float, y: float, z: float):
...
def point_light(r: float, g: float, b: float, x: float, y: float, z: float):
    """Adds a point light.
...
def light_specular(r: float, g: float, b: float):
