...
test_names_2d = [
    f"{dirname}/sanityTests/2DSanityTests/{name}"
    for name in os.listdir(os.path.join(dirname, "sanityTests/2DSanityTests"))
    if name not in ["__init__.py", "__pycache__"]
]

test_names_3d = [
    f"{dirname}/sanityTests/3DSanityTests/{name}"
    for name in os.listdir(os.path.join(dirname, "sanityTests/3DSanityTests"))
    if name not in ["__init__.py", "__pycache__"]
]
